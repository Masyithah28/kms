...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_FILES['berkas']['name'])) {
        ...
        if (move_uploaded_file($fileTmpName, $filePath)) {
            $query = "UPDATE tb_berkas SET id_berkas = $kode, nama_berkas = $namaBerkas, kategori = $kategori, status = $status, tgl_berlaku = $tgl_berlaku, nama_berkas = $namaBerkas WHERE id_berkas = $kode";
        ...
        $query = "UPDATE tb_berkas SET id_berkas = $kode, nama_berkas = $namaBerkas, kategori = $kategori, status = $status, tgl_berlaku = $tgl_berlaku WHERE id_berkas = $kode";
        $stmt = $conn->prepare($query);
