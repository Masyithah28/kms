...
<head>
    ...
    <title>Dokumen Kontrak / Perjanjian - PT Petrokopindo Cipta Selaras</title>
...
<body>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-kontrak.php" class="dropdown-item active">Kontrak / Perjanjian</a></li>
    ...
    <div class="content-container">
        ...
        <div class="header-container d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <h2 class="fw-bold mb-0">KONTRAK / PERJANJIAN</h2>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $result = selectPageKontrak($startpage, $batas);
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            xhr.open('GET', 'search-kontrak.php?query=' + encodeURIComponent(query), true);
        ...
        xhr.open('GET', `search-kontrak.php?query=${encodeURIComponent(query)}&column=${encodeURIComponent(column)}&direction=${encodeURIComponent(newDirection)}`, true);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-kontrak.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const kontrakLink = document.querySelector("a[href='index-kontrak.php']");

                // Menambah kelas 'show' pada dropdown untuk tetap terbuka
                if (dokumenDropdown && kontrakLink) {
                    dokumenDropdown.classList.add("show");
                    kontrakLink.classList.add("active");
                }
            }
        });
    </script>
