...
<body>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $nomor_urut = 0;
                    $result = selectSistemDataTDokumen();
                    ...
                    $result = selectPageSistemTDokumen($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-sistem.php") {
                const dokumenDropdown1 = document.querySelector("#dokumenDropdown1");
                const sistemLink = document.querySelector("a[href='index-sistem.php']");

                // Menambah kelas 'show' pada dropdown untuk tetap terbuka
                if (dokumenDropdown1 && sistemLink) {
