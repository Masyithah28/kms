      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-inovasi.php" class="dropdown-item active">Hasil Inovasi & Benchmarking</a></li>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-inovasi.php") {
                ...
                const inovasiLink = document.querySelector("a[href='index-inovasi.php']");
