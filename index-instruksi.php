...
<head>
    ...
    <title>Dokumen Instruksi Kerja - PT Petrokopindo Cipta Selaras</title>
...
<body>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-instruksi.php" class="dropdown-item active">Instruksi Kerja</a></li>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $result = selectPageInstruksi($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-instruksi.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const instruksiLink = document.querySelector("a[href='index-instruksi.php']");
