...
$roles = [
    'admin' => 'Super Admin',
    'user'  => 'User',
    'alber1' => 'Alber Wilayah 1',
    'alber2' => 'Alber Wilayah 2',
    'alber3' => 'Alber Wilayah 3',
...
<body>
    ...
    <div class="sidenav">
        ...
        <a href="manajemen-akun.php" class="nav-link active"><i class="fas fa-user-cog icon"></i>Manajemen Akun</a>
        <!-- New Menu for Admin -->
        <?php endif; ?>
        ...
        <nav>
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if ($page <= 1) echo 'disabled'; ?>">
                    <a class="page-link" href="<?php if ($page > 1) echo "?p=$prevPage";
                                                else echo '#'; ?>">&laquo;
                        Previous</a>
                </li>
