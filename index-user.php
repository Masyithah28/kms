...
<head>
    ...
    <title>Knowledge Management System - PT Petrokopindo Cipta Selaras</title>
...
<body>
    ...
    <div class="logo-card">
      ...
      <a href="index-user.php" class="nav-link active"><i class="fas fa-home icon"></i>Master Dokumen</a>
    ...
    <div class="content-container">
        ...
        $totalDocuments = countTotalDocuments();
        $activeDocuments = countActiveDocuments();
        $inactiveDocuments = countInactiveDocuments();
        ?>
        <div class="header-container">
            <h2 class="fw-bold">STATISTIK</h>
        </div>
        <div class="container mt-4">
            <div class="row">
                <!-- Card untuk Total Dokumen -->
                <div class="col-md-4">
                    <div class="card custom-card text-center p-3 mb-4">
                        <div class="card-body">
                            <div class="icon-container total">
                                <i class="fas fa-file-alt icon-con"></i>
                            </div>
                            <h5 class="card-title mt-2">Total Dokumen</h5>
                            <h2 class="card-text count-number"><?php echo $totalDocuments; ?></h2>
                        </div>
                    </div>
                </div>

                <!-- Card untuk Dokumen Aktif -->
                <div class="col-md-4">
                    <div class="card custom-card text-center p-3 mb-4">
                        <div class="card-body">
                            <div class="icon-container aktif">
                                <i class="fas fa-check-circle icon-con"></i>
                            </div>
                            <h5 class="card-title mt-2">Dokumen Aktif</h5>
                            <h2 class="card-text count-number"><?php echo $activeDocuments; ?></h2>
                        </div>
                    </div>
                </div>

                <!-- Card untuk Dokumen Tidak Aktif -->
                <div class="col-md-4">
                    <div class="card custom-card text-center p-3 mb-4">
                        <div class="card-body">
                            <div class="icon-container tidak-aktif">
                                <i class="fas fa-times-circle icon-con"></i>
                            </div>
                            <h5 class="card-title mt-2">Dokumen Tidak Aktif</h5>
                            <h2 class="card-text count-number"><?php echo $inactiveDocuments; ?></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="header-container d-flex justify-content-between align-items-center mb-3">
            <h2 class="mb-0 fw-bold">DAFTAR DOKUMEN</h2>
    ...
    <script>
        ...
        xhr.open('GET', `search.php?query=${encodeURIComponent(query)}&column=${encodeURIComponent(column)}&direction=${encodeURIComponent(newDirection)}`, true);
