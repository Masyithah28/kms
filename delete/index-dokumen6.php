...
$data = getInovasiData($startpage, $batas);
?>
...
<body>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-dokumen6.php" class="dropdown-item active">Hasil Inovasi & Benchmarking</a></li>
    ...
    <div class="content-container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                $result = getInovasiData($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-dokumen6.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const inovasiLink = document.querySelector("a[href='index-dokumen6.php']");
