...
$data = getLainnyaData($startpage, $batas);
?>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-dokumen7.php" class="dropdown-item active">Lainnya</a></li>
            </ul>
        </div>
    ...
    <div class="content-container">
        ...
        <div class="header-container d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <h2 class="fw-bold mb-0">LAINNYA</h2>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                $result = getLainnyaData($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-dokumen7.php") {
                ...
                if (dokumenDropdown && lainnyaLink) {
