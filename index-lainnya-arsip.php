...
<body>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $result = selectPageLainnya($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-lainnya-arsip.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const lainnyaLink = document.querySelector("a[href='index-lainnya-arsip.php']");
