...
$data = getProsedurData($startpage, $batas);
?>
...
<head>
    ...
    <title>Dokumen Prosedur - PT Petrokopindo Cipta Selaras</title>
...
<body>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-dokumen2.php" class="dropdown-item active">Prosedur</a></li>
    ...
    <div class="content-container">
        ...
        <div class="header-container d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <h2 class="fw-bold mb-0">PROSEDUR</h2>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                $result = getProsedurData($startpage, $batas);
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            // Buat permintaan AJAX ke search-prosedur.php
            const xhr = new XMLHttpRequest();
            xhr.open('GET', 'search-prosedur.php?query=' + encodeURIComponent(query), true);
        ...
        xhr.open('GET', `search-prosedur.php?query=${encodeURIComponent(query)}&column=${encodeURIComponent(column)}&direction=${encodeURIComponent(newDirection)}`, true);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-dokumen2.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const prosedurLink = document.querySelector("a[href='index-dokumen2.php']");

                // Menambah kelas 'show' pada dropdown untuk tetap terbuka
                if (dokumenDropdown && prosedurLink) {
                    dokumenDropdown.classList.add("show");
                    prosedurLink.classList.add("active");
                }
            }
        });
    </script>
