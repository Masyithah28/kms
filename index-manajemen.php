...
<body>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-manajemen.php" class="dropdown-item active">Manajemen Risiko</a></li>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $result = selectPageManajemen($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-manajemen.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const manajemenLink = document.querySelector("a[href='index-manajemen.php']");
