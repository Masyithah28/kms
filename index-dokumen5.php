...
$data = getSistemData($startpage, $batas);
?>
...
<body>
      ...
      <a href="index-admin.php" class="nav-link"><i class="fas fa-home icon"></i>Master Dokumen</a>
        ...
        <div class="collapse" id="dokumenDropdown">
            <ul class="list-unstyled ms-3">
                ...
                <li><a href="index-dokumen5.php" class="dropdown-item active">Sistem Informasi Manajemen</a></li>
    ...
    <div class="content-container">
        ...
        <div class="header-container d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <h2 class="fw-bold mb-0">SISTEM INFORMASI MANAJEMEN</h2>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                $result = getSistemData($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-dokumen5.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const sistemLink = document.querySelector("a[href='index-dokumen5.php']");
