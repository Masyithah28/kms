...
<body>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    $result = selectPageProsedur($startpage, $batas);
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (currentPath === "index-prosedur.php") {
                const dokumenDropdown = document.querySelector("#dokumenDropdown");
                const prosedurLink = document.querySelector("a[href='index-prosedur.php']");
